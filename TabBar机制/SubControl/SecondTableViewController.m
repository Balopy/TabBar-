...
static NSString *cellID_2 = @"SecondTableViewControllerID";
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"BLListTableViewCell" bundle:nil] forCellReuseIdentifier:cellID_2];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BLListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID_2];
